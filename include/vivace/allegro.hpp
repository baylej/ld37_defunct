/*
	Copyright 2016-2017 Jonathan Bayle, Thomas Medioni
...
class al_file_deleter: public al_deleter<ALLEGRO_FILE, bool, al_fclose> {};
...
//class al_audio_recorder_deleter: public al_deleter<ALLEGRO_AUDIO_RECORDER, void, al_destroy_audio_recorder> {}; // FIXME: not found!
