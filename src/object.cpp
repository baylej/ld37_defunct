...
void Object_mixed_aggregator::add(Object& object)
{
...
void Object_mixed_aggregator::update(double delta_t)
{
    Object_split_aggregator::update(delta_t);
}

void Object_mixed_aggregator::draw()
{
    Object_split_aggregator::draw();
}

void Object_mixed_aggregator::handle(const ALLEGRO_EVENT& event)
{
